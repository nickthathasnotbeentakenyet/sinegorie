...
if(!$_SESSION['loggedin'] || $_SESSION['clientData']['clientLevel'] < 3){
    ...
    $_SESSION['message'] = "<p class='failure'>Редактирование рецензий доступно только модераторам<br>
    Пользовательские рецензии доступны для редактирования в <a class='revmanLink2' href='/sinegorie/accounts/?action=admin'>личном кабинете</a></p>";
    exit;
   }
?><!DOCTYPE html>
<html lang="ru-ru">
...
<body>
    <div class="wrapper">
        <div class="content">
            ...
            <main>
        <h1>Удаление рецензии, нарушающей правила</h1>
