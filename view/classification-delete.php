    ...
    <div class="wrapper">
        <div class="content">
            ...
            <main>
                ...
                ?>
                <div>
                <form class="classUpdate-form" action="/sinegorie/poetry/index.php" method="POST">
                    <p class="warning">Внимание! Это действие необратимо. Вы уверены что хотите удалить жанр?</p>
                    <label>Выберите жанр</label><br>
                    <?php echo $classificationSelector ?><br>
                    <input type="submit" name="deleteGenre" value="Удалить">
                    <input type="hidden" name="action" value="deleteClassification">
                </form>
            </main>
        </div>
        <div class="footer">
